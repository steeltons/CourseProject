...
public class ProductTreeController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        LinkedList<AVLTree<Product>.Node> list = ProductDatabase.getInstance().getSortedList();
        ArrayList<String> addedList = new ArrayList<>();
        TreeItem<String>[] array = new TreeItem[list.size()];
        int counter = 0;
        for(AVLTree<Product>.Node node : list){
